...
#   write_pdb(model_array, basename + '_model.pdb')
    ...
    s,Dt,Dr,vbar_prot,Rht,ffo_hyd_P,M,Ro,Rhr,int_vis,a_b_ratio,Ft,Rg,Dmax,tauC, \
           asphr,int_vis,tot_hydration,vbar_hyd_prot,ks,TanfordBex,kd, \
           AA,NA,GL,DT,PG,useNumpy  = Sved(all_atm_rec,num_MG,num_MN,model_array)
