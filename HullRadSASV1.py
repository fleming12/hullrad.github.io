...
def mesh_from_pdb(file):
    ...
    return all_atm_array,num_MG,num_MN,num_K,num_Na,model_array,mesh_coords,tot_asa,prb_rad
...
def mesh_from_cif(file):
    ...
    return all_atm_rec,num_MG,num_MN,num_K,num_Na,model_array,mesh_coords,tot_asa,prb_rad	
...
def Sved(all_atm_rec,num_MG,num_MN,num_K,num_Na,model_array,mesh_coords,tot_asa,prb_rad):
    #
...
if __name__ == "__main__":
    ...
    if extension == 'pdb' or extension == 'ent':
        all_atm_rec,num_MG,num_MN,num_K,num_Na,model_array,mesh_coords,tot_asa,prb_rad = mesh_from_pdb(file)
    elif extension == 'cif':
        all_atm_rec,num_MG,num_MN,num_K,num_Na,model_array,mesh_coords,tot_asa,prb_rad = mesh_from_cif(file)
...
#   write_pdb(model_array, basename + '_model.pdb')
    ...
    s,Dt,Dr,vbar_prot,Rht,ffo_hyd_P,M,Ro,Rhr,int_vis,a_b_ratio,Ft,Rg,Dmax,tauC, \
           ...
           = Sved(all_atm_rec,num_MG,num_MN,num_K,num_Na,model_array,mesh_coords,tot_asa,prb_rad)
